(function (window, document, Laya) {
    ...
    var Arith = laya.maths.Arith, Bezier = laya.maths.Bezier, Bitmap = laya.resource.Bitmap,
        Browser = laya.utils.Browser;
    var Byte = laya.utils.Byte, Color = laya.utils.Color, ColorFilter = laya.filters.ColorFilter, Config = Laya.Config,
        Context = laya.resource.Context;
    var Event = laya.events.Event, Filter = laya.filters.Filter, Graphics = laya.display.Graphics,
    ...
    var Handler = laya.utils.Handler, Loader = laya.net.Loader, Matrix = laya.maths.Matrix, Point = laya.maths.Point,
        Rectangle = laya.maths.Rectangle;
    var Render = laya.renders.Render, RenderContext = laya.renders.RenderContext,
    ...
    var Style = laya.display.css.Style, System = laya.system.System, Text = laya.display.Text,
        Texture = laya.resource.Texture;
    var TransformInfo = laya.display.css.TransformInfo, URL = laya.net.URL, Utils = laya.utils.Utils,
        ...
        DrawText.__init$ = function () {
            ...
            CharValue = (function () {
                ...
                __proto.value = function (font, fillColor, borderColor, lineWidth, scaleX, scaleY, underLine) {
                    ...
                    var key = font.toString() + scaleX + scaleY + lineWidth + (fillColor ? fillColor.toLowerCase() : " ") + (borderColor ? borderColor.toLowerCase() : " ") + underLine;
    ...
    var WebGL = (function () {
        ...
        WebGL.enable = function () {
            ...
            // WebGL.__textures = [];
            // var fct = WebGL.mainContext.createTexture;
            // WebGL.mainContext.createTexture = function () {
            //     var result = fct.call(WebGL.mainContext);
            //     WebGL.__textures.push(result);
            //     result.___source = (new Error()).stack;
            //     return result;
            // }
            //
            // var fdt = WebGL.mainContext.deleteTexture;
            // WebGL.mainContext.deleteTexture = function (texture) {
            //     fdt.call(WebGL.mainContext, texture);
            //     var array = WebGL.__textures;
            //     var index = array.indexOf(texture);
            //     if (index === -1) {
            //         return;
            //     }
            ...
            RunDriver.createFilterAction = function (type) {
                var action;
                switch (type) {
                    case /*laya.filters.Filter.COLOR*/
                        0x20:
    ...
    var WebGLContext2D = (function (_super) {
        ...
        __proto.destroy = function () {
            ...
            this._targets = null;
            this._canvas && this._canvas._removeReference();
            this._canvas = null;
    ...
    var Atlaser = (function (_super) {
        ...
        __proto.computeUVinAtlasTexture = function (texture, oriUV, offsetX, offsetY) {
            ...
            var u1 = offsetX / _width, v1 = offsetY / _height, u2 = (offsetX + texture.bitmap.width) / _width,
    ...
    var RenderTarget2D = (function (_super) {
        ...
        __proto.clear = function (r, g, b, a) {
            ...
            switch (this._depthStencilFormat) {
                case /*laya.webgl.WebGLContext.DEPTH_COMPONENT16*/
                    0x81A5:
                ...
                case /*laya.webgl.WebGLContext.STENCIL_INDEX8*/
                    ...
                    break;
                case /*laya.webgl.WebGLContext.DEPTH_STENCIL*/
                    0x84F9:
                    clearFlag |= /*laya.webgl.WebGLContext.DEPTH_BUFFER_BIT*/0x00000100;
                    clearFlag |= /*laya.webgl.WebGLContext.STENCIL_BUFFER_BIT*/0x00000400
                    break;
    ...
    var WebGLImage = (function (_super) {
        function WebGLImage(data, def, format, mipmap, width, height) {
            /**@private */
            this._format = 0;
            /**@private */
            this._mipmap = false;
            ...
            if ((typeof data == 'string')) {
                ...
                this._h = height;
                this._image = data;
                this._format = ((data.byteLength / (width * height)) == 4) ? 0x1908 : 0x1907;
            } else {
                this._src = def;
                this._url = this._src;
        ...
        __proto._createWebGlTexture = function () {
            ...
            if (Render.isConchWebGL) {
                switch (this._format) {
                    case /*laya.webgl.WebGLContext.RGB*/
                        0x1907:
                    case /*laya.webgl.WebGLContext.RGBA*/
                        0x1908:
                        ...
                        gl.texImage2DEx(true, /*laya.webgl.WebGLContext.TEXTURE_2D*/0x0DE1, 0, this._format, this._format, /*laya.webgl.WebGLContext.UNSIGNED_BYTE*/0x1401, this._image);
                        break;
                ...
                switch (this._format) {
                    ...
                    case /*laya.webgl.WebGLContext.RGBA*/
                        0x1908:
                        if (this._image instanceof Uint8Array) {
                            gl.texImage2D(/*laya.webgl.WebGLContext.TEXTURE_2D*/0x0DE1, 0, this._format, this._w, this._h, 0, this._format, /*laya.webgl.WebGLContext.UNSIGNED_BYTE*/0x1401, this._image);
                        } else {
                            gl.texImage2D(/*laya.webgl.WebGLContext.TEXTURE_2D*/0x0DE1, 0, this._format, this._format, /*laya.webgl.WebGLContext.UNSIGNED_BYTE*/0x1401, this._image);
                        }

                        if (this._w >= 2048 * 2 || this._h >= 2048 * 2) {
                            let arr = this._src.split(".");
                            let desc = "【" + this._src + "】可能不是一张图片!";
                            if (arr.length != 1) {
                                desc = "【" + this._src + "】分辨率过于庞大!"
                            }
                            console.warn("绘图异常! 大致原因: " + desc, "宽:", this._w, "高:", this._h);
                        }
