(function (window, document, Laya) {
    ...
    var Ease = laya.utils.Ease, Event = laya.events.Event, EventDispatcher = laya.events.EventDispatcher,
    ...
    var Input = laya.display.Input, Loader = laya.net.Loader, Node = laya.display.Node, Point = laya.maths.Point,
        Rectangle = laya.maths.Rectangle;
    var Render = laya.renders.Render, Sprite = laya.display.Sprite, Text = laya.display.Text,
...
//class laya.ui.AutoBitmap extends laya.display.Graphics
    var AutoBitmap = (function (_super) {
        ...
        __proto.destroy = function () {
            ...
            if (this._weakKeys) {
                for (var i = 0, length = this._weakKeys.length; i < length; ++i) {
                    Loader.clearObject(this, this._weakKeys[i]);
                }
                this._weakKeys = null;
            }
        ...
        __proto.changeSource = function () {
            ...
            if (!sizeGrid || (sw === width && sh === height)) {
                ...
                var cmds = Loader.findObject(key);
                if (Utils.isOKCmdList(cmds)) {
                    this._weakKey = key;
                    Loader.keepObject(this, this._weakKey);
                    this.cmds = cmds;
                    return;
                }
                this.clear();
                ...
                var t, weakKey;
                if (left && top) {
                    t = AutoBitmap.getTexture(source, 0, 0, left, top);
                    weakKey = this._weakKeys[0];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[0] = t.weakKey;
                        }
                        this.drawTexture(t, 0, 0, left, top);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[0] = "";
                    }
                ...
                if (right && top) {
                    t = AutoBitmap.getTexture(source, sw - right, 0, right, top);
                    weakKey = this._weakKeys[1];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[1] = t.weakKey;
                        }
                        this.drawTexture(t, width - right, 0, right, top);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[1] = "";
                    }
                ...
                if (left && bottom) {
                    t = AutoBitmap.getTexture(source, 0, sh - bottom, left, bottom);
                    weakKey = this._weakKeys[2];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[2] = t.weakKey;
                        }
                        this.drawTexture(t, 0, height - bottom, left, bottom);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[2] = "";
                    }
                ...
                if (right && bottom) {
                    t = AutoBitmap.getTexture(source, sw - right, sh - bottom, right, bottom);
                    weakKey = this._weakKeys[3];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[3] = t.weakKey;
                        }
                        this.drawTexture(t, width - right, height - bottom, right, bottom);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[3] = "";
                    }
                ...
                if (top) {
                    t = AutoBitmap.getTexture(source, left, 0, sw - left - right, top);
                    weakKey = this._weakKeys[4];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[4] = t.weakKey;
                        }
                        this.drawBitmap(repeat, t, left, 0, width - left - right, top);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[4] = "";
                    }
                ...
                if (bottom) {
                    t = AutoBitmap.getTexture(source, left, sh - bottom, sw - left - right, bottom);
                    weakKey = this._weakKeys[5];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[5] = t.weakKey;
                        }
                        this.drawBitmap(repeat, t, left, height - bottom, width - left - right, bottom);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[5] = "";
                    }
                ...
                if (left) {
                    t = AutoBitmap.getTexture(source, 0, top, left, sh - top - bottom);
                    weakKey = this._weakKeys[6];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[6] = t.weakKey;
                        }
                        this.drawBitmap(repeat, t, 0, top, left, height - top - bottom);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[6] = "";
                    }
                ...
                if (right) {
                    t = AutoBitmap.getTexture(source, sw - right, top, right, sh - top - bottom);
                    weakKey = this._weakKeys[7];
                    if (t) {
                        if (weakKey != t.weakKey) {
                            Loader.clearObject(this, weakKey);
                            Loader.keepObject(this, t.weakKey);
                            this._weakKeys[7] = t.weakKey;
                        }
                        this.drawBitmap(repeat, t, width - right, top, right, height - top - bottom);
                    } else {
                        Loader.clearObject(this, weakKey);
                        this._weakKeys[7] = "";
                    }
                }
                t = AutoBitmap.getTexture(source, left, top, sw - left - right, sh - top - bottom);
                weakKey = this._weakKeys[8];
                if (t) {
                    if (weakKey != t.weakKey) {
                        Loader.clearObject(this, weakKey);
                        Loader.keepObject(this, t.weakKey);
                        this._weakKeys[8] = t.weakKey;
                    }
                    this.drawBitmap(repeat, t, left, top, width - left - right, height - top - bottom);
                } else {
                    Loader.clearObject(this, weakKey);
                    this._weakKeys[8] = "";
                }
                ...
                if (this.autoCacheCmd && !Render.isConchApp) {
                    Loader.saveObject(key, this.cmds, null);
                    this._weakKey = key;
                    Loader.keepObject(this, this._weakKey);
                }
            }
        ...
        AutoBitmap.getTexture = function (tex, x, y, width, height) {
            ...
            var texture = Loader.findObject(key);
            if (!texture || !texture.source) {
                texture = Texture.createFromTexture(tex, x, y, width, height);
                if (texture) {
                    Loader.saveObject(key, texture);
                    texture.weakKey = key;
                }
            }
            return texture;
...
//class laya.ui.Button extends laya.ui.Component
    var Button = (function (_super) {
        ...
        __proto.changeClips = function () {
            ...
            if (!img) {
                console.log("lose skin,res url: ", this._skin);
                return;
            }
            Loader.clearObject(this, this._weakKey);
            ...
            var clips = Loader.findObject(key);
            ...
            if (clips) {
                ...
                if (this._stateNum === 1) {
                    ...
                    for (var i = 0; i < this._stateNum; i++) {
                        var texture = Texture.createFromTexture(img, 0, height * i, width, height);
                        // if (texture) {
                        //     texture.bitmap._addReference();
                        // }
                        this._sources.push(texture);
                    }
                }
                Loader.saveObject(key, this._sources);
                this._weakKey = key;
                Loader.keepObject(this, this._weakKey);
            }
            if (this._autoSize) {
                ...
                if (clips) {
                    ...
                    for (var i = 0; i < this._clipY; i++) {
                        for (var j = 0; j < this._clipX; j++) {
                            var texture = Texture.createFromTexture(img, w * j, h * i, w, h);
                            // if (texture) {
                            //     texture.bitmap._addReference();
                            // }
                            this._sources.push(texture);
