...
namespace modules.illusion {
    ...
    export class PetIllusionPanel extends IllusionViewUI {

        private static _instance: PetIllusionPanel;
        public static get instance(): PetIllusionPanel {
            return this._instance = this._instance || new PetIllusionPanel();
        }
        ...
        protected initialize(): void {
            ...
            this._btnGroup.setFuncIds(ActionOpenId.rideFeed, ActionOpenId.rideRank, ActionOpenId.petMagicShow, ActionOpenId.rideRefine, ActionOpenId.rideFazhen);
        ...
        public setListIndex() {
            let showIds: number[] = PetMagicShowCfg.instance.getShowIds();
            ...
            for (let i: int = 0, len: int = showIds.length; i < len; i++) {
                let lv: number = 0;
                let showInfo = MagicPetModel.instance.getShowInfoById(showIds[i]);
                if (showInfo) {
                ...
                if (illusion.IllusionModel.instance.magicShowId == showIds[i] && nextCfg) {
                    this._list.selectedIndex = i;
                    break;
                }
            }
        ...
        private selectShowModel(): void {
            // console.log(666,this._selectedId);
        ...
        private updatePetInfo(): void {
            ...
            this._info = MagicPetModel.instance.magicShow;
        ...
        private selectHandler(): void {
            ...
            let showInfo: MagicShowInfo = MagicPetModel.instance.getShowInfoById(showId);
            let star: int = showInfo ? showInfo[MagicShowInfoFields.star] : 0;
            let cfg: petMagicShow = PetMagicShowCfg.instance.getCfgByIdAndLv(showId, star);
            let itemId: int = cfg[petMagicShowFields.items][0];
            let count: int = cfg[petMagicShowFields.items][1];
            ...
            let usingShowId: number = IllusionModel.instance.magicShowId;
            ...
            let nextCfg: petMagicShow = PetMagicShowCfg.instance.getCfgByIdAndLv(showId, star + 1);
            this.setAttrs(cfg, nextCfg);
        }

        // 设置属性加成列表
        private setAttrs(cfg: petMagicShow, nextCfg: petMagicShow) {
        ...
        private showTip(pitchId: int): void {
            ...
            let cfg: petMagicShow = PetMagicShowCfg.instance.getCfgByIdAndLv(pitchId, 0);
            let str: string = cfg[rideMagicShowFields.getWay];
        ...
        private totalAttrHandler(): void {
            ...
            WindowManager.instance.openDialog(WindowEnum.ATTR_ALERT,
                ["宠物幻化总属性",
                    ...
                    PetMagicShowCfg.instance.attrIndices
                ]);
        }

        // 宠物幻化提示
        private tipsHandler(): void {
            CommonUtil.alertHelp(20004);
        }
        ...
        private upgrade(): void {
            ...
            if (this._countDiff >= 0) {
                IllusionCtrl.instance.riseMagicShow([this._selectedId]);
                IllusionModel.instance._magicSelectId = this._selectedId;
            } else
        ...
        private switchHandler(): void {
            let showInfo: MagicShowInfo = MagicPetModel.instance.getShowInfoById(this._selectedId);

            if (showInfo && showInfo[MagicShowInfoFields.star] > 0) {
                IllusionCtrl.instance.changeMagicShow([this._selectedId]);
            }
        }
