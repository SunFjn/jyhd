...
namespace modules.treasure {
    export class TreasureZhiZunPanel extends TreasurePanel {
        protected initialize(): void {
            super.initialize();
            this._type = 2;
            this.artImg.skin = "treasure/image_xb_txt3.png";
            this.titleImg.skin = "treasure/txt_xbjm_jdxb.png";

            this.regGuideSpr(GuideSpriteId.TREASURE_ZHIZUN_BTN, this.oneBtn);
        ...
        public setOpenParam(value: number): void {
            super.setOpenParam(2);
        }
        public probabilityNoticeFun() {
            CommonUtil.alertHelp(74505);
        }
    }
}