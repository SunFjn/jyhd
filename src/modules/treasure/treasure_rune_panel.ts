...
namespace modules.treasure {
    ...
    export class TreasureRunePanel extends ui.TreasureRuneViewUI {
        ...
        private _rewardList: CustomList;
        ...
        public destroy(destroyChild: boolean = true): void {
            ...
            this._rewardList = this.destroyElement(this._rewardList);
        ...
        protected initialize(): void {
            ...
            this._showItem = [this.item1, this.item2];
            ...
            this._personalList.itemRender = TreasureItemText1;
            ...
            this._rewardList = new CustomList();
            this._rewardList.itemRender = TreasureRuneItem;
            this._rewardList.hCount = 4;
            this._rewardList.spaceY = 0;
            this._rewardList.spaceX = 45;
            this._rewardList.width = 535;
            this._rewardList.height = 276;
            this._rewardList.x = 50;
            this._rewardList.y = 0;
            this.itemPanel.addChild(this._rewardList);
        ...
        public setOpenParam(value: number): void {
            ...
            if (value != null) {
                ...
                this._buttonList.selectedData = 3;
            }
            this.selectHandler();
        }
        ...
        private selectHandler(): void {
            ...
            if (type != this._type) {
                ...
                for (let i = 0; i < this._showItem.length; i++) {
                    ...
                    this._showItem[i]._qualityBg.visible = false;
                ...
                let arrAward = new Array<any>();

                for (let index = 2; index < showItems.length; index++) {
                    let element = showItems[index];
                    if (element) {
                        let itm = [element, 0, 0, null];
                        arrAward.push(itm);
                    }
                }
                this._rewardList.datas = arrAward;
                this.updateCost();
            }
        }
        ...
        public updateShowItemList(): void {
            ...
            this._rewardList.scrollPos += 1 * (Laya.stage.frameRate === Laya.Stage.FRAME_SLOW ? 2 : 1);
            if (this._rewardList.scrollPos >= (this._rewardList.getListH - this._rewardList.height)) {
                this._rewardList.scrollPos = 0;
            }
            ...
            if (svrList != null) {
                if (svrList.length > 0) {
                    ...
                    for (let i = 0; i < svrList.length; i++) {
                        ...
                        let shuju = CommonUtil.getFuWenNameAndLv(itemId);
                        let str = `${shuju[0]} Lv.${shuju[1]}`;
                        ...
                        html += `<span style='color:${itemColor};font-size: 20px;'>${str}</span>`;
        ...
        protected onOpened(): void {
            ...
            if (this._rewardList.getListH > this._rewardList.height) {
