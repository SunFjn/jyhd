...
namespace modules.ceremony_cash {
    ...
    export class CeremonyDanbiPanel extends ui.CeremonyDanbiViewUI {
        ...
        protected initialize(): void {
            ...
            this._list.height = 676 - 11;
            this._list.hCount = 1;
            this._list.spaceX = 0;
            this._list.spaceY = 6;
            this._list.x = 15;
            this._list.y = 300;
            this._list.zOrder = 300;
            this._list.itemRender = CeremonyDanbiItem;
        ...
        protected addListeners(): void {
            ...
            this.addAutoListener(GlobalData.dispatcher, CommonEventType.OS_CEREMONY_DANBI_UPDATE, this, this.showUI);
        ...
        public showUI() {
            let shuju = CeremonyDanbiCfg.instance.getCfg();
        ...
        public onOpened(): void {
            super.onOpened();
            CeremonyDanbiCtrl.instance.GetPaySingleFSInfo();
            this.showUI1();
        }
        public showUI1() {
        ...
        private sortFunc(a: ceremony_danbi, b: ceremony_danbi): number {
            let rewarList: Array<CeremonyDanbiReward> = CeremonyDanbiModel.instance.rewardList;
            let aID: number = a[CeremonyDanbiRewardFields.id];
            let bID: number = b[CeremonyDanbiRewardFields.id];
            let aState: number = rewarList[aID] ? CeremonyDanbiModel.instance.getState(rewarList[aID]) : 0;
            let bState: number = rewarList[bID] ? CeremonyDanbiModel.instance.getState(rewarList[bID]) : 0;
        ...
        private setActivitiTime(): void {
            Laya.timer.clear(this, this.activityHandler);
            let isOpen = FuncOpenModel.instance.getFuncIsOpen(ActionOpenId.singleRecharge);
            if (CeremonyDanbiModel.instance.restTm >= GlobalData.serverTime && isOpen) {
        ...
        private activityHandler(): void {
                ...
                this.activityText.text = `${modules.common.CommonUtil.timeStampToDayHourMinSecond(CeremonyDanbiModel.instance.restTm)}`;
            if (CeremonyDanbiModel.instance.restTm < GlobalData.serverTime) {
                this.activityText1.color = "#FF3e3e";
                this.activityText1.text = "活动已结束";
                Laya.timer.clear(this, this.activityHandler);
            }
