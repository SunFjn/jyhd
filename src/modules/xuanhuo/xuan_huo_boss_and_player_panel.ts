...
///<reference path="../config/scene_xuanhuo_arena_cfg.ts"/>
namespace modules.xuanhuo {
    import CustomList = modules.common.CustomList;
    import Event = Laya.Event;
    import ClasSsceneXuanhuoBossCfg = modules.config.ClasSsceneXuanhuoBossCfg;
    ...
    export class XuanhuoBossAndPlayerListPanel extends ui.XuanhuoBossAndPlayerListViewUI {
        ...
        protected initialize(): void {
            ...
            this._list.width = 290;
            this._list.height = 115;
            this._list.hCount = 1;
            this._list.itemRender = XuanhuoBossListItemItem;
            this._list.x = 340;
            this._list.y = 36;
            ...
            this._listPlayer.width = 320;
            this._listPlayer.height = 115;
            this._listPlayer.hCount = 1;
            this._listPlayer.itemRender = XuanhuoBossPlayerListItemItem;
        ...
        protected addListeners(): void {
            ...
            this.addAutoListener(this.title1Txt, Event.CLICK, this, () => {
                XuanHuoModel.instance.playerType = 0
                this._titleIndex = 0
                this.changUI()
                this.changPlayerUI();
            });
            this.addAutoListener(this.title2Txt, Event.CLICK, this, () => {
                XuanHuoModel.instance.playerType = 1
                this._titleIndex = 1
                this.changUI()
                this.changPlayerUI();
            });
            ...
            // this.addAutoListener(GlobalData.dispatcher, CommonEventType.Xuanhuo_SCORE_UPDATE, this, this.noneWhileOneHandler);
        }
         ...
         */
        public changUI() {
            this.title1Txt.color = this._titleIndex == 0 ? "#e3e85a" : "#FFFFFF"
            this.title2Txt.color = this._titleIndex == 1 ? "#e3e85a" : "#FFFFFF"
            this.imgselect1.visible = this._titleIndex == 0
            this.imgselect2.visible = this._titleIndex == 1
            if (this._listState) {
        ...
        public playerBoss() {
            return;
            console.log("playerBoss")
            let nossId = DungeonModel.instance.getLiveBoss();
            XuanHuoModel.instance.setSelectTarget(nossId, true);
        }
        ...
        public updateBossInfo(bolll: boolean = false): void {
            //测试数据
            let infos = ClasSsceneXuanhuoBossCfg.instance.getBossInfoByGrade(1);
            infos.sort(this.sortOverd.bind(this));
            console.log("刷新boss状态", infos);
            ...
            if (bolll) {
                if (infos) {
                    ...
                    BossDungeonModel.instance.searchBossType = SCENE_ID.scene_xuanhuo_boss;
                    this.playerBoss();
                }
            }
        }
        public sortOverd(A: scene_xuanhuo_arena, B: scene_xuanhuo_arena): number {
            let areaIdA = A[scene_xuanhuo_arenaFields.areaId];
            let areaIdB = B[scene_xuanhuo_arenaFields.areaId];
            if (areaIdA > areaIdB) {
                return 1
            }
            else {
        ...
        private updatePlayerInfo(): void {
            ...
            if (this._titleIndex == 0) {
                ...
                arr = own.concat(attack, attacked, common);
            } else {

                let datasPlayer: Array<[number, string, number, boolean]> = XuanHuoModel.instance.getCopyHumanData();
                for (let data of datasPlayer) {
                    own.push([data[0], data[1], 0]);
                }
                arr = own
            }
