...
namespace modules.daw {
    ...
    export class DawRewardPanel extends PayRewardViewUI {
        ...
        protected initialize(): void {
            ...
            for (let i = 0; i < this._showItem.length; i++) {
                ...
                // } else {
                    this._showItem[i].addChild(clip);
                    clip.pos(-14, -15, true);
                    clip.skin = "assets/effect/item_effect1.atlas";
                    for (let i = 0; i < 16; i++) {
                        let str = `item_effect1/${i}.png`;
                        urlArr.push(str);
                    }
                // }
        ...
        public initializeClip() {
            ...
            this._oneBtnBtnClip.pos(122, 998, true);
            ...
            this._tenBtnBtnClip.pos(382, 998, true);
            ...
            this._prizeEffect.pos(488, 767, true);
        }
    }
}
