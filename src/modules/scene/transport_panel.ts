...
namespace modules.scene {
    import TransportViewUI = ui.TransportViewUI;
    ...
    export class TransportPanel extends TransportViewUI {
        ...
        private updateTriggeredNpc(): void {
            ...
            //     this.startGather();
            // } else if (this._func == 6) {   //仙府收集的那些东西
