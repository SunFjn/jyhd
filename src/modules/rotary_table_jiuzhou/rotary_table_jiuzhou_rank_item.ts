...
namespace modules.rotary_table_jiuzhou {
    ...
    export class RotaryTableJiuZhouRankItem extends ui.RotaryTableJiFenItemUI {
        ...
        protected addListeners(): void {
            super.addListeners();
            // this.addAutoListener(GlobalData.dispatcher, CommonEventType.ROTARYTABLE_JIUZHOU_UPDATE, this, this.showText);
        }
        ...
        protected setData(value: jzduobao_reward): void {
            super.setData(value);
            if (value) {
                this._date = value;
                this.updateUI();
        ...
        public showReward() {
            ...
            let rewardItems = this._date[jzduobao_rewardFields.reward];
            if (rewardItems) {
         ...
         */
        public showText() {
            let condition = this._data[jzduobao_rewardFields.condition];
            let id = this._data[jzduobao_rewardFields.id];
            let caifu = RotaryTableJiuZhouModel.instance.score;
            if (caifu >= condition) {
            ...
            let state = RotaryTableJiuZhouModel.instance.getRewardStart(id);
