namespace modules.sprint_rank {
    ...
    import SprintXianYiRankViewUI = ui.SprintXianYiRankViewUI;
    import CommonUtil = modules.common.CommonUtil;
    import SkeletonAvatar = modules.common.SkeletonAvatar;

    export class SpintXianYiRankPanel extends SprintXianYiRankViewUI {
        ...
        private setBtnSure(): void {
            if (this._endFlag == 1) {
                RedPointCtrl.instance.setRPProperty("sprintRankXianYiRP", false);
         ...
         */
        public showRank() {
            SprintRankModel.instance._skipId = WindowEnum.SPRINT_RANKTASK_XIANYI_PANEL;//暂时记录上个打开的面板
        ...
        public initializeModelClip() {
            ...
            // this._modelClip.pos(200, 630, true);
            ...
            this._skeletonClip.pos(200, 630, true);
