...
namespace modules.sprint_rank {
    ...
    import SprintXianQiRankViewUI = ui.SprintXianQiRankViewUI;
    import CommonUtil = modules.common.CommonUtil;
    import SkeletonAvatar = modules.common.SkeletonAvatar;

    export class SpintXianQiRankPanel extends SprintXianQiRankViewUI {
        ...
        private setBtnSure(): void {
            if (this._endFlag == 1) {
                RedPointCtrl.instance.setRPProperty("sprintRankXianQiRP", false);
         ...
         */
        public showRank() {
            SprintRankModel.instance._skipId = WindowEnum.SPRINT_RANKTASK_XIANQI_PANEL;//暂时记录上个打开的面板
        ...
        public initializeModelClip() {
            ...
            this._skeletonClip.pos(200, 690, true);
