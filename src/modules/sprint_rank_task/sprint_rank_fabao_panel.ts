namespace modules.sprint_rank {
    ...
    import SprintFaBaoRankViewUI = ui.SprintFaBaoRankViewUI;
    import CommonUtil = modules.common.CommonUtil;
    import SkeletonAvatar = modules.common.SkeletonAvatar;

    export class SpintFaBaoRankPanel extends SprintFaBaoRankViewUI {
        ...
        private setBtnSure(): void {
            if (this._endFlag == 1) {
                RedPointCtrl.instance.setRPProperty("sprintRankFaBaoRP", false);
         ...
         */
        public showRank() {
            SprintRankModel.instance._skipId = WindowEnum.SPRINT_RANKTASK_FABAO_PANEL;//暂时记录上个打开的面板
        ...
        public initializeModelClip() {
            ...
            this._skeletonClip.pos(200, 665, true);
