namespace modules.sprint_rank {
    ...
    import SprintFightingRankViewUI = ui.SprintFightingRankViewUI;
    import CommonUtil = modules.common.CommonUtil;
    import SkeletonAvatar = modules.common.SkeletonAvatar;

    export class SpintFighitingRankPanel extends SprintFightingRankViewUI {
        ...
        private setRankTaskReward(): void {
            ...
            let curType: number = SprintRankTaskModel.instance.curType;
        ...
        public showTaskReward() {
            ...
            this.MissionStatementText.innerHTML = `${this._cfg[sprint_rank_taskFields.name]}达到<span style='color:#168a17'>&nbsp;${this._cfg[sprint_rank_taskFields.condition]}</span>,可领取!`;
        ...
        private setBtnSure(): void {
            if (this._endFlag == 1) {
                RedPointCtrl.instance.setRPProperty("sprintRankFighitingRP", false);
         ...
         */
        public showRank() {
            SprintRankModel.instance._skipId = WindowEnum.SPRINT_RANKTASK_FIGHTING_PANEL;//暂时记录上个打开的面板
