namespace modules.sprint_rank {
    ...
    import SprintShenBingRankViewUI = ui.SprintShenBingRankViewUI;
    import CommonUtil = modules.common.CommonUtil;
    import SkeletonAvatar = modules.common.SkeletonAvatar;

    export class SpintShenBingRankPanel extends SprintShenBingRankViewUI {
        ...
        private setBtnSure(): void {
            if (this._endFlag == 1) {
                RedPointCtrl.instance.setRPProperty("sprintRankShenBingRP", false);
         ...
         */
        public showRank() {
            SprintRankModel.instance._skipId = WindowEnum.SPRINT_RANKTASK_SHENBING_PANEL;//暂时记录上个打开的面板
        ...
        private setRankReward(): void {
            ...
            if (isModel == 2) {//图片
                ...
                //新增 统一处理
                // this._modelClip.y = 700;
                this._skeletonClip.y = 640;
        ...
        public initializeModelClip() {
            ...
            // this._modelClip.pos(200, 700, true);
            ...
            this._skeletonClip.pos(200, 640, true);
