...
namespace modules.sprint_rank {
    ...
    import SprintLingChongRankViewUI = ui.SprintLingChongRankViewUI;
    import CommonUtil = modules.common.CommonUtil;
    import SkeletonAvatar = modules.common.SkeletonAvatar;

    export class SpintLingChongRankPanel extends SprintLingChongRankViewUI {
        ...
        private setBtnSure(): void {
            if (this._endFlag == 1) {
                RedPointCtrl.instance.setRPProperty("sprintRankLingChongRP", false);
         ...
         */
        public showRank() {
            SprintRankModel.instance._skipId = WindowEnum.SPRINT_RANKTASK_LINGCHONG_PANEL;//暂时记录上个打开的面板
        ...
        private setRankReward(): void {
            ...
            if (isModel == 2) {//图片
                ...
                if (isModel == 1) {
                    ...
                    if (typeNum == 2) {  //宠物
                        this._skeletonClip.x = 150;
                        this._skeletonClip.y = 680;
                        this._skeletonClip.resetScale(AvatarAniBigType.clothes, 0.6)
