...
namespace modules.kuanghuan {
    ...
    import KuangHuanLevelViewUI = ui.KuangHuanLevelViewUI;
    import KuanghuanTask = Protocols.KuanghuanTask;
    import KuanghuanTaskFields = Protocols.KuanghuanTaskFields;
    import Event = laya.events.Event;
    export class KuangHuanLevelPanel extends KuangHuanLevelViewUI {
        //List滑动条
        ...
        public showUI() {
            ...
            if (modules.zhizun.ZhizunModel.instance.state == 0) { //自尊
        ...
        public okBtnHandler() {
            ...
            if (modules.zhizun.ZhizunModel.instance.state == 0) {
        ...
        private updateItem() {
            ...
            for (let i: int = 0; i < nodeList.length; i++) {
                if (nodeList[i][KuanghuanNoteFields.type] == 1) {
        ...
        private setActivitiTime(): void {
            ...
            if (this._activityTime) {
                let isOpen = modules.funcOpen.FuncOpenModel.instance.getFuncIsOpen(ActionOpenId.kuanghuan);
        ...
        private activityHandler(): void {
            this.activityText.text = `${CommonUtil.timeStampToDayHourMin(this._activityTime)}`;
            if (this._activityTime < GlobalData.serverTime) {
                this.activityText1.color = "#FF3e3e";
                this.activityText.visible = false;
                this.activityText1.text = "活动已结束";
