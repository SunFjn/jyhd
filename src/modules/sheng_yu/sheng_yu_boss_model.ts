...
namespace modules.sheng_yu {
    ...
    export class ShengYuBossModel {
        private static _instance: ShengYuBossModel;
        public static get instance(): ShengYuBossModel {
            return this._instance = this._instance || new ShengYuBossModel();
        }
        ...
        public get tiliLimit(): number {
            return this._tiliLimit;
        }

        public set tiliLimit(value: number) {
            this._tiliLimit = value;
        }
        //根据BOSSID获取服务器BOSS信息
        ...
        public addHandler(): void {
            ...
            let TiLiDanNum = BagModel.instance.getItemCountById(ShengYuBossModel.instance.itemId);
            if (TiLiDanNum > 0) {
                let count: number = 1;
                ...
                BagUtil.openLackPropAlert(ShengYuBossModel.instance.itemId, 1);
            }
