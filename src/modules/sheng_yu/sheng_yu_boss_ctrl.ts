...
namespace modules.sheng_yu {
    ...
    export class ShenYuBossCtrl extends BaseCtrl {
        private static _instance: ShenYuBossCtrl;
        public static get instance(): ShenYuBossCtrl {
            return this._instance = this._instance || new ShenYuBossCtrl();
        }
        ...
        */
        ...
        private GetStrengthRelpy(tuple: GetStrengthRelpy): void {
            ...
            if (tuple) {
                ...
                ShengYuBossModel.instance.tiliLimit = tuple[GetStrengthRelpyFields.addLimit];
