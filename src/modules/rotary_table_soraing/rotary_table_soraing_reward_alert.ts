...
namespace modules.rotary_table_soraing {
    ...
    export class RotaryTableSoaringRewardAlert extends ui.RotaryTableRewardAlertUI {
        private _list: List;
        ...
        public playEffect(value: any): void {
            ...
            for (let i = 0; i < effectItems.length; i++) {
                ...
                GlobalData.dispatcher.event(CommonEventType.ROTARYTABLE_SOARING_EFFECT, [arr]);
            }
        }
        ...
        protected addListeners(): void {
            ...
            // this.addAutoListener(GlobalData.dispatcher, CommonEventType.ROTARYTABLE_SOARING_UPDATE, this, this.changDrawNum);
        }
