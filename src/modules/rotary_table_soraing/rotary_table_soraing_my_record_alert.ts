...
namespace modules.rotary_table_soraing {
    ...
    export class RotaryTableSoaringMyRecordAlert extends ui.PayRewardMyRecordAlertUI {
        ...
        protected initialize(): void {
            ...
            this._list.hCount = 1;
            this._list.spaceX = 0;
            this._list.itemRender = RotaryTableSoaringMyRecordItem;
            this._list.x = 67;
            this._list.y = 109;
        ...
        public updateMyRecord(): void {
            let PayRewardNoteList: Array<PayRewardNote> = RotaryTableSoaringModel.instance.PayRewardNoteList;
