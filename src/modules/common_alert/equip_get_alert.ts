namespace modules.commonAlert {
    ...
    export class EquipGetAlert extends ui.LackPropAlertUI {
        ...
        public set item(cfg: equip_suit) {
            ...
            this.lineimage.y = this.Title.y + 35;
            this._sourceBtnY = this.lineimage.y + this.lineimage.height + 16;
            let arr: number[] = BlendCfg.instance.getCfgById(34501)[blendFields.intParam];
