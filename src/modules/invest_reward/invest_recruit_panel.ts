...
namespace modules.invest_reward {
    import InvestRecruitRewardUI = ui.InvestRecruitRewardUI;
    ...
    export class InvestRecruitPanel extends InvestRecruitRewardUI {
        ...
        private _updateView(): void {
            this.setBtnSure();
            //0登录返利1闯关法力2为成长返利
            this.arr = InvestRewardCfg.instance.getCfgBytype(1);
        ...
        private setBtnSure(): void {
            ...
            let value = stateList[1];//0登录返利1闯关法力2为成长返利
            if (value) {
        ...
        private sureBtnHandler(): void {
            ...
            let VipLevel = VipModel.instance.vipLevel;
            if (gold >= this.grow && VipLevel >= this.vipLevel) {
                InvestRewardCtrl.instance.getBuyInvestReward([1]);
