...
namespace modules.invest_reward {
    import InvestLoginRewardUI = ui.InvestLoginRewardUI;
    ...
    export class InvestLoginPanel extends InvestLoginRewardUI {
       ...
       private _cfgItem: invest_reward;
        ...
        public onOpened(): void {
            super.onOpened();
            this.setItem(0);//0登录返利1闯关法力2为成长返利
            this._updateView();
            this._btnClip.play();
        }
        ...
        private _updateView(): void {
            this.setBtnSure();
            this.arr = InvestRewardCfg.instance.getCfgBytype(0);//0登录返利1闯关法力2为成长返利
        ...
        private setBtnSure(): void {
            ...
            let value = stateList[0];//0登录返利1闯关法力2为成长返利
            if (value) {
        ...
        private sureBtnHandler(): void {
            ...
            let VipLevel = VipModel.instance.vipLevel;
            if (gold >= this.grow && VipLevel >= this.vipLevel) {
                InvestRewardCtrl.instance.getBuyInvestReward([0]);
                this._btnClip.visible = true;
        ...
        //     let rpVisible1:boolean=false;
        //     let rpVisible2:boolean=false;
        //     let rpVisible3:boolean=false;
        //     for (let key in  rewarList) {
        //         if (rewarList[key][InvestrewardRewardFields.state] == 1) {
        //             if (rewarList[key][InvestrewardRewardFields.taskId] == 0) {
        //                 this.investRP1.visible = true;
        //                 rpVisible1=true;
        //             }
        //             else if (rewarList[key][InvestrewardRewardFields.taskId] == 1) {
        //                 this.investRP2.visible = true;
        //                 rpVisible2=true;
        //             }
        //             else if(rewarList[key][InvestrewardRewardFields.taskId] == 2) {
        //                 this.investRP3.visible = true;
        //                 rpVisible3=true;
        //             }
        //         }
        //         this.investRP1.visible = rpVisible1;
        //         this.investRP2.visible = rpVisible2;
        //         this.investRP3.visible = rpVisible3;
        //     }
        // }
