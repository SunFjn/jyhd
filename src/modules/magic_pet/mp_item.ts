...
namespace modules.magicPet {
     ...
     */
    export class MPItem extends SbItemUI {
        ...
        protected setData(value: any): void {
            ...
            let _showInfo: MagicShowInfo = MagicPetModel.instance.huanhuaList.get(this._showId);
            ...
            curShowId = MagicPetModel.instance.fazhenId;

            this.usingTxt.visible = false;

            let cfg = PetFazhenCfg.instance.getHuanhuaCfgByIdAndLev(this._showId, star);
            let nextCfg = PetFazhenCfg.instance.getHuanhuaCfgByIdAndLev(this._showId, star + 1);
        ...
        private getWay(pitchId: int): string {
            ...
            let str: string = cfg[pet_fazhenFields.getWay];
            let str1: string = "";
