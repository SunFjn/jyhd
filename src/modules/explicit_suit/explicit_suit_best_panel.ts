...
namespace modules.explicit {
    ...
    export class ExplicitSuitBestPanel extends ExplicitSuitViewUI {
        ...
        protected initialize(): void {
            ...
            this._numDiff = 0;
            this.title_txt.skin = "explicit_suit/txt_jueptz.png";
        ...
        private initList(){
           let data = ExteriorSuitCfg.instance.getCfgByClass(ExteriorSuitClass.best)
           let items = [];
