...
namespace modules.explicit {
    ...
    export class ExplicitSuitCollectionPanel extends ExplicitSuitViewUI {
        ...
        protected initialize(): void {
            ...
            this._numDiff = 0;
            this.title_txt.skin = "explicit_suit/txt_dctz.png";
        ...
        private initList(){
           let data = ExteriorSuitCfg.instance.getCfgByClass(ExteriorSuitClass.collection)
           let items = [];
