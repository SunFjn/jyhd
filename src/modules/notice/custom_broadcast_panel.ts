...
namespace modules.notice {
    ...
    export class CustomBroadcastPanel extends Component {
        private _bg: Image;
        //private _txt: Text;
        ...
        private _tweenJS2: TweenJS;
        private _tweenJS3: TweenJS;
        ...
        constructor() {
            ...
            this._bg = new Image("common_sg/new_banner.png");
        ...
        private tween(): void {
            ...
            this._tweenJS = TweenJS.create(this._html).to({ x: 20 }, 600).chain(
                this._tweenJS2 = TweenJS.create(this._html).to({ x: 0 - this._html.contextWidth }, 5000).chain(
                    this._tweenJS3 = TweenJS.create(this._html).delay(0).onComplete(this.delayHandler.bind(this))
                ).delay(2000)
            ).start();
        ...
        private delayHandler(): void {
            if (this._broadcasts.length > 0) {
                ...
                if (this._tweenJS && this._tweenJS.isPlaying) this._tweenJS.stop();
                if (this._tweenJS2 && this._tweenJS2.isPlaying) this._tweenJS2.stop();
                if (this._tweenJS3 && this._tweenJS3.isPlaying) this._tweenJS3.stop();
