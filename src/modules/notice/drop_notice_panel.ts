...
namespace modules.notice {
    ...
    export class DropNoticePanel extends Sprite {
        private _bg: Image;
        private _txt: Text;
        ...
        constructor() {
            ...
            this._getTxt.width = 60;
            this._getTxt.pos(90, 7, true);
            this._getTxt.text = `获得 `;
            this._getTxt.color = `#b8b8b8`;
        ...
        public setTxt(txt: string, color: string): void {
            this._txt.text = txt;
