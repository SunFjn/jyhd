...
///<reference path="../config/scene_copy_marry_cfg.ts"/>
namespace modules.marry {
    import MarryBattleAwardViewUI = ui.TeamBattleAwardViewUI;
    import Event = Laya.Event;
    import BagItem = modules.bag.BagItem;
    import Layer = ui.Layer;
    import scene_copy_marry = Configuration.scene_copy_marry;
    import SceneCopyMarryCfg = modules.config.SceneCopyMarryCfg;
    import Items = Configuration.Items;
    import scene_copy_marryFields = Configuration.scene_copy_marryFields;
    import ItemsFields = Configuration.ItemsFields;
    import BaseItem = modules.bag.BaseItem;

    export class MarryBattleAwardPanel extends MarryBattleAwardViewUI {
        constructor() {
            super();
        }
        ...
        protected addListeners(): void {
            ...
            GlobalData.dispatcher.on(CommonEventType.MARRY_BATTLE_LEVEL_UPDATE, this, this.awardUpdate);
        }

        protected removeListeners(): void {
            super.removeListeners();
            this.awardBoxBtn.off(Event.CLICK, this, this.isShowAward);
            GlobalData.dispatcher.off(CommonEventType.MARRY_BATTLE_LEVEL_UPDATE, this, this.awardUpdate);
        }

        //显示获得的奖励
        private awardUpdate(): void {
            let cfg: scene_copy_marry = SceneCopyMarryCfg.instance.getCfgByWare(MarryModel.instance.currWave);
            if (!cfg) return;
            let awardArr: Array<Items> = cfg[scene_copy_marryFields.award];
            ...
            this.levelName.text = `第${MarryModel.instance.currWave}波`;
            this.updataShowAward();
        }
