...
namespace modules.marry {
    ...
    export class MarryTaskDayItem extends ui.MarryTaskDayItemUI {
        ...
        protected setData(value: any): void {
            ...
            let cfg = MarryModel.instance.getTask(taskId, 1)
            ...
            this.myTxt.text = "我:" + cfg[2]
            this.otherTxt.text = "对方:" + cfg[3]
            if (cfg[0] == 0) {
                //未完成
            ...
            this.progressTxt.text = cfg[1] + "/" + cfg2[marry_taskFields.condition]
            this.progressBar.width = (cfg[1] / cfg2[marry_taskFields.condition]) * this.proWidth;
