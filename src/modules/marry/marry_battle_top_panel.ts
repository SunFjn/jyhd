...
namespace modules.marry {
    import MarryBattleTopViewUI = ui.TeamBattleTopViewUI;
    ...
    export class MarryBattleTopPanel extends MarryBattleTopViewUI {
        constructor() {
            super();
        }
        ...
        protected addListeners(): void {
            ...
            GlobalData.dispatcher.on(CommonEventType.MARRY_BATTLE_LEVEL_UPDATE, this, this.updataWaveShow);
        ...
        protected removeListeners(): void {
            ...
            GlobalData.dispatcher.off(CommonEventType.MARRY_BATTLE_LEVEL_UPDATE, this, this.updataWaveShow);
        ...
        private updataWaveShow(): void {
            ...
            this.levelShowNum.value = MarryModel.instance.currWave.toString();
            ...
            if (MarryModel.instance.timeState) {  //显示跳转提示
        ...
        private noticeUpdate(): void {
            ...
            if (MarryModel.instance.isMaxWave) {
                this.tipBox.visible = false;
                ...
                this.noticeLevelShow.text = (MarryModel.instance.skipWave + MarryModel.instance.currWave).toString();
