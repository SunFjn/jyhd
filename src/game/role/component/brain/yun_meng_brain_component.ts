...
//
//
//     const enum YunMengBrainPriority {
//         Death,
//         Transmit,
//         Abnormal,
//         TargetChange,
//     }
//
//     export class YunMengBrainComponent extends RoleComponent {
...
//                     new EventNode(new DeathAction(owner), this._interrupt, YunMengBrainPriority.Death)
//                 ).addChild(
//                     new EventNode(new AbnormalAction(owner), this._interrupt, YunMengBrainPriority.Abnormal)
//                 ).addChild(
//                     new EventNode(new NpcTriggerAction(owner), this._interrupt, YunMengBrainPriority.TargetChange)
//                     // ).addChild(
...
//             this._interrupt.trigger(YunMengBrainPriority.Transmit);
//         }
//
//         private interrupt(status: number): void {
//             if (status == RoleState.DEATH || status == RoleState.REVIVE) {
//                 this._interrupt.trigger(YunMengBrainPriority.Death);
//             }
//         }
//
//         private onTargetChange(): void {
//             this._interrupt.trigger(YunMengBrainPriority.TargetChange);
//         }
//
//         private updateAbnormal(state: number): void {
//             if (state & ActorState.dizz) {
//                 this._interrupt.trigger(YunMengBrainPriority.Abnormal);
//             }
