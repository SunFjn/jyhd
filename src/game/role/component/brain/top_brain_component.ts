...
namespace game.role.component.brain {
    ...
    export class TopBrainComponent extends RoleComponent {
        ...
        constructor(owner: Role) {
            ...
            this._tree = BehaviorTree.create(
                new SelectorMonitor(this._interrupt).addChild(
                    ...
                    new Sequence().addChild(new ChaseAndAttack(owner, 1000, SelectTargetType.Player)).addChild(new Patrol(owner, 1000, SelectTargetType.Player))
                ).addChild(
